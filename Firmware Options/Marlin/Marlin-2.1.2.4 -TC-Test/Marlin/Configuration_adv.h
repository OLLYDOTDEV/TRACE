...
#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS X_BED_SIZE   // Set to X_MAX_POS
  #define X2_MIN_POS X_MIN_POS      
  #define X2_MAX_POS X_BED_SIZE 
  ...
  #define DEFAULT_DUAL_X_CARRIAGE_MODE DXC_DUPLICATION_MODE
