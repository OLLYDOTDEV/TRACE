...
namespace Language_en {
  ...
  LSTR MSG_PAUSE_PRINT                    = _UxGT("Pause Cut");
  LSTR MSG_ADVANCED_PAUSE                 = _UxGT("Advanced Pause");
  LSTR MSG_RESUME_PRINT                   = _UxGT("Resume Cut");
  LSTR MSG_HOST_START_PRINT               = _UxGT("Start Host Cut");
  LSTR MSG_STOP_PRINT                     = _UxGT("Stop Cut");
  ...
  LSTR MSG_CONTINUE_PRINT_JOB             = _UxGT("Continue Cut Job");
  LSTR MSG_MEDIA_MENU                     = _UxGT("Cut from ") MEDIA_TYPE_EN;
  LSTR MSG_NO_MEDIA                       = _UxGT("No ") MEDIA_TYPE_EN;
  LSTR MSG_DWELL                          = _UxGT("Sleep...");
  LSTR MSG_USERWAIT                       = _UxGT("Click to Resume...");
  LSTR MSG_PRINT_PAUSED                   = _UxGT("Cut Paused");
  LSTR MSG_PRINTING                       = _UxGT("Printing...");
  LSTR MSG_STOPPING                       = _UxGT("Stopping...");
  LSTR MSG_REMAINING_TIME                 = _UxGT("Remaining");
  LSTR MSG_PRINT_ABORTED                  = _UxGT("Cut Aborted");
  LSTR MSG_PRINT_DONE                     = _UxGT("Cut Done");
  ...
  LSTR MSG_KILL_EXPECTED_PRINTER          = _UxGT("INCORRECT PRINTER");
    ...
    LSTR MSG_INFO_PRINT_COUNT_RESET       = _UxGT("Reset Cut Count");
    LSTR MSG_INFO_PRINT_COUNT             = _UxGT("Cut Count");
    LSTR MSG_INFO_PRINT_TIME              = _UxGT("Cut Time");
