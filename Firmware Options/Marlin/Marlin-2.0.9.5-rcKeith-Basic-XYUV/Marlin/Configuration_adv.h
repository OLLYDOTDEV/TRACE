...
//#define USE_CONTROLLER_FAN
  ...
  //#define CONTROLLER_FAN2_PIN -1           // Set a custom pin for the controller fan 2
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100, 100, 100, 100, 100 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//
#if HAS_ADC_BUTTONS
  #define ADC_BUTTON_DEBOUNCE_DELAY 500  // Increase if buttons bounce or repeat too fast
#endif
